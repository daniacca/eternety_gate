// schemas.types.ts
// Canonical Types for: StoryPack, Runtime Actor/Items/Party, GameSave
// Decisions baked in:
// - D100 tests with DoS/DoF
// - Stats are unbounded numbers (not capped at 100)
// - Magic system is CN-only (channeling accumulates DoS; casting requires CN DoS)
// - Bonuses are step-based (+10 increments)
// - Party-ready (size >= 1) and single-player is a valid case
